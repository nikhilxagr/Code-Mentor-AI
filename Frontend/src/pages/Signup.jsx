      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-white/30 backdrop-blur-lg p-8 rounded-2xl shadow-xl border border-gray-100">
          ...
          <p className="text-center text-gray-500 mb-6">
            Join thousands of developers learning DSA
          </p>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full bg-gradient-to-r from-purple-600 to-blue-600 text-white py-3 rounded-lg font-semibold hover:from-purple-700 hover:to-blue-700 transition transform hover:scale-[1.02] disabled:opacity-50 disabled:cursor-not-allowed disabled:transform-none shadow-lg"
            >
              {loading ? (
        ...
        <p className="text-center text-gray-500 text-sm mt-6">
          © 2026 CodeMentor AI. Empowering learners worldwide.
        </p>
      </div>
    </div>
  );
